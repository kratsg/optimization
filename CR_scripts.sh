...
do
  ...
  python optimize.py cut ~/Dropbox/TheAccountant_dataFiles/TA07_MBJ10V2/Gtt_1L/fetch/data-optimizationTree/*.root ~/Dropbox/TheAccountant_dataFiles/TA07_MBJ10V2/ttbar*_1L/fetch/data-optimizationTree/*410000*r6765_r6282*.root ~/Dropbox/TheAccountant_dataFiles/TA07_MBJ10V2/ttbar*_1L/fetch/data-optimizationTree/*407012*r6765_r6282*p2411*.root --supercuts $supercutsLocation -o $cutsLocation --numpy -v -b
