...
python ../Optimization/graph-grid.py --summary summary_main.json --lumi 35 -o main --do-run1 --run1-excl ../Optimization/run1_limit.csv --run1-1sigma ../Optimization/run1_limit_1sigma.csv -b

# make a set of plots showing the optimal cuts
python ../Optimization/graph-cuts.py --summary summary_main.json --lumi 35 -o main --do-run1 --run1-excl ../Optimization/run1_limit.csv --run1-1sigma ../Optimization/run1_limit_1sigma.csv -b --outputHash outputHash/main --supercuts supercuts/main.json
